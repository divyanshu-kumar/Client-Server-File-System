...
constexpr Stat::Stat(
  ...
  , atime_(0)
  , mtime_(0)
  , atimtvsec_(int64_t{0})
  , atimtvnsec_(int64_t{0})
  , ctime_(0)
  , err_(0)
  , mtimtvsec_(int64_t{0})
  , mtimtvnsec_(int64_t{0}){}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_afsfuse_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::afsfuse::Stat, atimtvsec_),
  PROTOBUF_FIELD_OFFSET(::afsfuse::Stat, atimtvnsec_),
  PROTOBUF_FIELD_OFFSET(::afsfuse::Stat, mtimtvsec_),
  PROTOBUF_FIELD_OFFSET(::afsfuse::Stat, mtimtvnsec_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 47, -1, -1, sizeof(::afsfuse::FuseFileInfo)},
  { 60, -1, -1, sizeof(::afsfuse::ReadResult)},
  { 69, -1, -1, sizeof(::afsfuse::ReadRequest)},
  { 78, -1, -1, sizeof(::afsfuse::WriteRequest)},
  { 88, -1, -1, sizeof(::afsfuse::WriteResult)},
  { 96, -1, -1, sizeof(::afsfuse::CreateRequest)},
  { 105, -1, -1, sizeof(::afsfuse::CreateResult)},
  { 117, -1, -1, sizeof(::afsfuse::MkdirRequest)},
  { 125, -1, -1, sizeof(::afsfuse::OutputInfo)},
  { 133, -1, -1, sizeof(::afsfuse::RenameRequest)},
  { 142, -1, -1, sizeof(::afsfuse::UtimensRequest)},
  { 153, -1, -1, sizeof(::afsfuse::MknodRequest)},
  { 162, -1, -1, sizeof(::afsfuse::FileContent)},
  { 171, -1, -1, sizeof(::afsfuse::File)},
};
...
const char descriptor_table_protodef_afsfuse_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\r\n\005dtype\030\003 \001(\r\022\013\n\003err\030\004 \001(\005\"\216\002\n\004Stat\022\013\n\003"
  ...
  "ime\030\014 \001(\005\022\021\n\tatimtvsec\030\r \001(\003\022\022\n\natimtvns"
  "ec\030\016 \001(\003\022\021\n\tmtimtvsec\030\017 \001(\003\022\022\n\nmtimtvnse"
  "c\030\020 \001(\003\022\013\n\003err\030\021 \001(\005\"y\n\014FuseFileInfo\022\r\n\005"
  "flags\030\001 \001(\005\022\n\n\002fh\030\002 \001(\005\022\r\n\005oldfh\030\003 \001(\r\022\021"
  "\n\tlockowner\030\005 \001(\004\022\021\n\tpollevent\030\006 \001(\r\022\013\n\003"
  "err\030\004 \001(\005\022\014\n\004path\030\007 \001(\t\"<\n\nReadResult\022\021\n"
  ...
  "content\030\003 \001(\014\"\024\n\004File\022\014\n\004path\030\001 \001(\t2\346\006\n\003"
  "AFS\0223\n\017afsfuse_getattr\022\017.afsfuse.String\032"
  "\r.afsfuse.Stat\"\000\0227\n\017afsfuse_readdir\022\017.af"
  "sfuse.String\032\017.afsfuse.Dirent\"\0000\001\022>\n\014afs"
  "fuse_open\022\025.afsfuse.FuseFileInfo\032\025.afsfu"
  "se.FuseFileInfo\"\000\022;\n\014afsfuse_read\022\024.afsf"
  "use.ReadRequest\032\023.afsfuse.ReadResult\"\000\022>"
  "\n\rafsfuse_write\022\025.afsfuse.WriteRequest\032\024"
  ".afsfuse.WriteResult\"\000\022A\n\016afsfuse_create"
  "\022\026.afsfuse.CreateRequest\032\025.afsfuse.Creat"
  "eResult\"\000\022=\n\rafsfuse_mkdir\022\025.afsfuse.Mkd"
  "irRequest\032\023.afsfuse.OutputInfo\"\000\0227\n\rafsf"
  "use_rmdir\022\017.afsfuse.String\032\023.afsfuse.Out"
  "putInfo\"\000\0228\n\016afsfuse_unlink\022\017.afsfuse.St"
  "ring\032\023.afsfuse.OutputInfo\"\000\022\?\n\016afsfuse_r"
  "ename\022\026.afsfuse.RenameRequest\032\023.afsfuse."
  "OutputInfo\"\000\022A\n\017afsfuse_utimens\022\027.afsfus"
  "e.UtimensRequest\032\023.afsfuse.OutputInfo\"\000\022"
  "=\n\rafsfuse_mknod\022\025.afsfuse.MknodRequest\032"
  "\023.afsfuse.OutputInfo\"\000\022@\n\017afsfuse_putFil"
  "e\022\024.afsfuse.FileContent\032\023.afsfuse.Output"
  "Info\"\000(\001\022:\n\017afsfuse_getFile\022\r.afsfuse.Fi"
  "le\032\024.afsfuse.FileContent\"\0000\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_afsfuse_2eproto = {
  false, false, 2196, descriptor_table_protodef_afsfuse_2eproto, "afsfuse.proto", 
...
Stat::Stat(const Stat& from)
  ...
  ::memcpy(&dev_, &from.dev_,
    static_cast<size_t>(reinterpret_cast<char*>(&mtimtvnsec_) -
    reinterpret_cast<char*>(&dev_)) + sizeof(mtimtvnsec_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&mtimtvnsec_) -
    reinterpret_cast<char*>(&dev_)) + sizeof(mtimtvnsec_));
}
...
// @@protoc_insertion_point(message_clear_start:afsfuse.Stat)
  ...
  ::memset(&dev_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&mtimtvnsec_) -
      reinterpret_cast<char*>(&dev_)) + sizeof(mtimtvnsec_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 104)) {
          atimtvsec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 112)) {
          atimtvnsec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 120)) {
          mtimtvsec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 128)) {
          mtimtvnsec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Stat::_InternalSerialize(
  ...
  // int64 atimtvsec = 13;
  if (this->_internal_atimtvsec() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(13, this->_internal_atimtvsec(), target);
  }

  // int64 atimtvnsec = 14;
  if (this->_internal_atimtvnsec() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(14, this->_internal_atimtvnsec(), target);
  }

  // int64 mtimtvsec = 15;
  if (this->_internal_mtimtvsec() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(15, this->_internal_mtimtvsec(), target);
  }

  // int64 mtimtvnsec = 16;
  if (this->_internal_mtimtvnsec() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(16, this->_internal_mtimtvnsec(), target);
  }

  // int32 err = 17;
  if (this->_internal_err() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(17, this->_internal_err(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:afsfuse.Stat)
  ...
  // int64 atimtvsec = 13;
  if (this->_internal_atimtvsec() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_atimtvsec());
  }

  // int64 atimtvnsec = 14;
  if (this->_internal_atimtvnsec() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_atimtvnsec());
  }
  ...
  // int64 mtimtvsec = 15;
  if (this->_internal_mtimtvsec() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_mtimtvsec());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:afsfuse.Stat)
  ...
  if (from._internal_atimtvsec() != 0) {
    _internal_set_atimtvsec(from._internal_atimtvsec());
  }
  if (from._internal_atimtvnsec() != 0) {
    _internal_set_atimtvnsec(from._internal_atimtvnsec());
  }
  ...
  if (from._internal_mtimtvsec() != 0) {
    _internal_set_mtimtvsec(from._internal_mtimtvsec());
  }
  if (from._internal_mtimtvnsec() != 0) {
    _internal_set_mtimtvnsec(from._internal_mtimtvnsec());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void Stat::InternalSwap(Stat* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Stat, mtimtvnsec_)
      + sizeof(Stat::mtimtvnsec_)
