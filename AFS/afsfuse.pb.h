...
class Stat final :
 ...
 public:
  ...
  enum : int {
    ...
    kAtimtvsecFieldNumber = 13,
    kAtimtvnsecFieldNumber = 14,
    kCtimeFieldNumber = 12,
    kErrFieldNumber = 17,
    kMtimtvsecFieldNumber = 15,
    kMtimtvnsecFieldNumber = 16,
  };
  // uint32 dev = 1;
  void clear_dev();
  ...
  // int64 atimtvsec = 13;
  void clear_atimtvsec();
  ::PROTOBUF_NAMESPACE_ID::int64 atimtvsec() const;
  void set_atimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_atimtvsec() const;
  void _internal_set_atimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:

  // int64 atimtvnsec = 14;
  void clear_atimtvnsec();
  ::PROTOBUF_NAMESPACE_ID::int64 atimtvnsec() const;
  void set_atimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_atimtvnsec() const;
  void _internal_set_atimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  // int64 mtimtvsec = 15;
  void clear_mtimtvsec();
  ::PROTOBUF_NAMESPACE_ID::int64 mtimtvsec() const;
  void set_mtimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_mtimtvsec() const;
  void _internal_set_mtimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:

  // int64 mtimtvnsec = 16;
  void clear_mtimtvnsec();
  ::PROTOBUF_NAMESPACE_ID::int64 mtimtvnsec() const;
  void set_mtimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_mtimtvnsec() const;
  void _internal_set_mtimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 atimtvsec_;
  ::PROTOBUF_NAMESPACE_ID::int64 atimtvnsec_;
  ::PROTOBUF_NAMESPACE_ID::int32 ctime_;
  ::PROTOBUF_NAMESPACE_ID::int32 err_;
  ::PROTOBUF_NAMESPACE_ID::int64 mtimtvsec_;
  ::PROTOBUF_NAMESPACE_ID::int64 mtimtvnsec_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_afsfuse_2eproto;
};
// -------------------------------------------------------------------
...
// int64 atimtvsec = 13;
inline void Stat::clear_atimtvsec() {
  atimtvsec_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::_internal_atimtvsec() const {
  return atimtvsec_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::atimtvsec() const {
  // @@protoc_insertion_point(field_get:afsfuse.Stat.atimtvsec)
  return _internal_atimtvsec();
}
inline void Stat::_internal_set_atimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  atimtvsec_ = value;
}
inline void Stat::set_atimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_atimtvsec(value);
  // @@protoc_insertion_point(field_set:afsfuse.Stat.atimtvsec)
}

// int64 atimtvnsec = 14;
inline void Stat::clear_atimtvnsec() {
  atimtvnsec_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::_internal_atimtvnsec() const {
  return atimtvnsec_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::atimtvnsec() const {
  // @@protoc_insertion_point(field_get:afsfuse.Stat.atimtvnsec)
  return _internal_atimtvnsec();
}
inline void Stat::_internal_set_atimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  atimtvnsec_ = value;
}
inline void Stat::set_atimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_atimtvnsec(value);
  // @@protoc_insertion_point(field_set:afsfuse.Stat.atimtvnsec)
}

// int64 mtimtvsec = 15;
inline void Stat::clear_mtimtvsec() {
  mtimtvsec_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::_internal_mtimtvsec() const {
  return mtimtvsec_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::mtimtvsec() const {
  // @@protoc_insertion_point(field_get:afsfuse.Stat.mtimtvsec)
  return _internal_mtimtvsec();
}
inline void Stat::_internal_set_mtimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  mtimtvsec_ = value;
}
inline void Stat::set_mtimtvsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_mtimtvsec(value);
  // @@protoc_insertion_point(field_set:afsfuse.Stat.mtimtvsec)
}

// int64 mtimtvnsec = 16;
inline void Stat::clear_mtimtvnsec() {
  mtimtvnsec_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::_internal_mtimtvnsec() const {
  return mtimtvnsec_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Stat::mtimtvnsec() const {
  // @@protoc_insertion_point(field_get:afsfuse.Stat.mtimtvnsec)
  return _internal_mtimtvnsec();
}
inline void Stat::_internal_set_mtimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  mtimtvnsec_ = value;
}
inline void Stat::set_mtimtvnsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_mtimtvnsec(value);
  // @@protoc_insertion_point(field_set:afsfuse.Stat.mtimtvnsec)
}
